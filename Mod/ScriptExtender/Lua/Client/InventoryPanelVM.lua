...
local function RegisterTypes()
    ...
    Ext.UI.RegisterType("INVRW_SlotWrapper", {
        ...
        StackVisibility = { Type = "String", Notify = true },
        ...
        GhostName       = { Type = "String", Notify = true },
        GhostDesc       = { Type = "String", Notify = true },
...
function InventoryPanelVM.PopulateFromDataStore()
    ...
    for _, entry in ipairs(passingEntries) do
        ...
        wrapper.StackVisibility = stack > 1 and "Visible" or "Collapsed"
